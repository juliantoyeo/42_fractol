...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/17 09:31:17 by jyeo              #+#    #+#             */
/*   Updated: 2018/03/17 09:31:19 by jyeo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_iter(t_thr *t, t_bot new, t_bot pix, t_point cor)
{
	...
	while (i < max)
	{
		...
		new.im = 2 * fabs(old.re * old.im) + pix.im;
...
static int	ft_ship(t_thr *t, t_point cor, t_double zoom, t_double move)
{
	t_bot		pix;
	t_bot		new;
